...
const PresetLoadModal = (props) => {
  ...
  const onOpen=()=>{  
    axiosInstance.get(`/preset/${userSeq}/list`,{headers})
    .then(response=>{
          ...
          <div className = "modal-container">
            ...
            <div className="modal-form">
              <div className="modal-input">
                  <input className="modal-input-content" name="keyword" placeholder="검색어를 입력해주세요."></input>
              </div>
              <div className="preset-list">
                  {
                    presetList.map((preset,index)=>(
                      <div key={index} className="card" style={{ position: "relative" }} onClick={()=>{

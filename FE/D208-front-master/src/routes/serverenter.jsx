  ...
  useEffect(() => {
    const fetchServerData = async () => {
      try {
        ...
        setServerImage(response.data.image || "/withView.png");
  ...
  return (
    ...
    <div className="serverEnterMain">
      ...
      <div className="serverMembers">
          <img src="/usersicon.png" alt="Members" className="membersIcon" />
          <span>{serverMembersNumber}</span>
        </div>
        <button className="joinButton" onClick={handleJoin}>참가하기</button>
    </div>
  </div>
  );
};
